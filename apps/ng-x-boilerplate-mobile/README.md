...
- Run `nx run ng-x-boilerplate-mobile:auto-build-fin --isSoft=false --handleGit=true` to build the app + its app-shell + FIN process (`CHANGELOG.md` should be updated first).
