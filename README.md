...
- ## `2` [Library types & their relationship](./docs/getting-started/library-types-and-their-relationship.md)
  - ### `— a` [Library type vs functionality type](./docs/getting-started/library-types-and-their-relationship.md#library-type-vs-functionality-type)
  - ### `— b` [Quick decision cheat-sheet](./docs/getting-started/library-types-and-their-relationship.md#quick-decision-cheat-sheet)
  - ### `— c` [Types](./docs/getting-started/library-types-and-their-relationship.md#types)
    - `—— A` [Import matrix](./docs/getting-started/library-types-and-their-relationship.md#import-matrix)
    - `—— B` [Cross-cutting contracts](./docs/getting-started/library-types-and-their-relationship.md#cross-cutting-contracts)
    - `—— C` ['util' type](./docs/getting-started/library-types-and-their-relationship.md#util-type)
    - `—— D` ['map' type](./docs/getting-started/library-types-and-their-relationship.md#map-type)
    - `—— E` ['data-access' type](./docs/getting-started/library-types-and-their-relationship.md#data-access-type)
    - `—— F` ['ui' type](./docs/getting-started/library-types-and-their-relationship.md#ui-type)
    - `—— G` ['feature' type](./docs/getting-started/library-types-and-their-relationship.md#feature-type)
    - `—— H` ['page' type](./docs/getting-started/library-types-and-their-relationship.md#page-type)
    - `—— I` ['app' type](./docs/getting-started/library-types-and-their-relationship.md#app-type)
    - `—— J` ['api' type](./docs/getting-started/library-types-and-their-relationship.md#api-type)
  - ### `— d` [Functionality types](./docs/getting-started/library-types-and-their-relationship.md#functionality-types)
    - `—— A` [Natural entry lib](./docs/getting-started/library-types-and-their-relationship.md#natural-entry-lib)
    - `—— B` ['abstract' type](./docs/getting-started/library-types-and-their-relationship.md#abstract-type)
    - `—— C` ['visual' type](./docs/getting-started/library-types-and-their-relationship.md#visual-type)
    - `—— D` ['visual+' type](./docs/getting-started/library-types-and-their-relationship.md#visual+-type)
    - `—— E` ['mixed' type](./docs/getting-started/library-types-and-their-relationship.md#mixed-type)
    - `—— F` ['mixed+' type](./docs/getting-started/library-types-and-their-relationship.md#mixed+-type)
  - ### `— e` [Reuse across functionalities](./docs/getting-started/library-types-and-their-relationship.md#reuse-across-functionalities)
  - ### `— f` [Versioning shared libs](./docs/getting-started/library-types-and-their-relationship.md#versioning-shared-libs)
