...
Here are sample files from the 'feature' library of the 'ng-x-profile-info' functionality. Use them as inspiration when creating your own 'feature' libraries.

```
libs/shared/feature/ng-x-profile-info/
├── src/
│   ├── lib/v1/
...
@let xCredit_hasError_main = xCreditFacade.entityHasError$(nameInstance_main) |
