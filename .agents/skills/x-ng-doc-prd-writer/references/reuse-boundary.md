...
| -------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| A lib **this** functionality owns                                                            | **this** `docs/x/{domain}/{name}/PRD/README.md` — as an AC                            |
...
- A missing **functionality** (`map` / `data-access` / **single-purpose** `ui` / `feature` / `page`) needs its **own** PRD and TSD. Name it under Dependencies & Risks; do not absorb its ACs.
