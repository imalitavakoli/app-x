...
Output: the **folder** `docs/x/{functionality-name}/PRD/` — `README.md` (the PRD itself) plus `DECISIONS.md` (retired ACs · rejected product approaches · reversed decisions), in that functionality's folder. The TSD lives beside it under `docs/x/{functionality-name}/TSD/`.
