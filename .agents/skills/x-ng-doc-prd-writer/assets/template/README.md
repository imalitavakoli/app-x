...
>
> ACs later map to **e2e test cases** (grouped under user stories in the e2e app), so they are higher-level than the TSD's Business Rules. Write each as an observable outcome; Given/When/Then is encouraged. When updating this PRD, never renumber existing IDs — add new ones.
